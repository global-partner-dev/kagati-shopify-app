...
import { useIndexResourceState, Page, IndexTable, Text, InlineStack, Icon, Spinner, BlockStack, ChoiceList, DropZone, ButtonGroup, Button, Box, Banner, Thumbnail, Toast, Frame } from "@shopify/polaris";
...
const StoresPage = () => {
  ...
  const storeSync = async () => {
    const response = await storeUpdate({ syncType: "store" });
