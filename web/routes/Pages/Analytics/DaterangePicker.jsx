...
// const DateRangePicker = React.forwardRef(({ onDateRangeChange }, ref) => {
function DateRangePicker({ onDateRangeChange }) {
  ...
  function handleCalendarChange({ start, end }) {
    ...
    // onDateRangeChange(newDateRange.period);
    // console.log("first", newDateRange);
  }
  function apply() {
  ...
  //   const newActiveDateRange = ranges.find((range) => range.alias === value[0]);
  //   setActiveDateRange(newActiveDateRange);
  //   onDateRangeChange(newActiveDateRange);
