    ...
    const calculateOrderTotals = (data) => {
      ...
      if (data.lineItems && data.lineItems.edges) {
          ...
          for (const item of lineItems) {
              ...
              totalPrice += parseFloat(node.price);
              totalQuantity += 1; // Assuming quantity is part of the node structure
                                      ...
                                      {priceOrderData?.taxLines ? 
                                        <Box paddingBlock="150">
                                          <InlineStack align="space-between">
                                            ...
                                            <InlineStack align="space-between">
                                              <TextComponent 
                                                textTitle={`${formatTaxLines(priceOrderData?.taxLines)}`} // Accessing the tax lines from the node
                                                textVariant="headingXs"
                                                textAs="h6" 
                                              />
                                            </InlineStack>
                                            <TextComponent
                                              textTitle={`${orderData?.currency === "INR" ? "₹" : "$"}${priceOrder?.totalTax}`}
                                              textVariant="bodyLg"
                                              textAs="span"
                                            />
                                          </InlineStack>
